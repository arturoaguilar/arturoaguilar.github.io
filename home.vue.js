...
<p v-show="spaceshipTranslate" class="section__tool__translate-screen"><span class="translate-screen__title">Traductor de tu nave:</span>Bienvenido al planeta del diseño de productos y desarrollo de ideas innovadoras. Gracias por hacer contacto. Espero que podamos trabajar juntos. <button class="translate-screen__close-button">Cerrar</button></p>
